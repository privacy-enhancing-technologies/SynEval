...
class TestMetricsValidation:
    ...
    def setup_method(self):
        ...
        self.original_data = pd.DataFrame({
            ...
            'text': ['Great product', 'Excellent quality', 'Good value', 'Amazing', 'Perfect', 
                    'Not bad', 'Okay', 'Good', 'Excellent', 'Poor']
        })
    ...
    def test_fidelity_metrics_output(self):
        ...
        evaluator = FidelityEvaluator(self.synthetic_data, self.original_data, self.metadata)
    ...
    def test_diversity_metrics_output(self):
        ...
        evaluator = DiversityEvaluator(self.synthetic_data, self.original_data, self.metadata)
        result = evaluator.evaluate()
