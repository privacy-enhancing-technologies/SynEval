...
The test runner script has been removed. Use pytest directly:
...
Pytest configuration is now in `pyproject.toml` under `[tool.pytest.ini_options]`:
- Test discovery patterns
- Coverage settings (--cov=., --cov-report=...)
- Warning filters
