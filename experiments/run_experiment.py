...
from experiments.run_dp_evaluation import DashboardDPEvaluationRunner  # type: ignore
...
def main() -> int:
    ...
    result = runner._run_single_experiment(experiment)  # pylint: disable=protected-access
    runner.all_results[experiment.experiment_id] = result

    # Generate the individual dashboard only.
    runner._call_individual_report_generator(experiment, result)  # pylint: disable=protected-access
